...
var $adtext = (function ()
{
 ...
 var config = {
  ...
  supportedBrowsers: 'firefox,iphone,xie,chrome,xsafari,xopera',
 ...
 var properties = {
  url_afid: 'crossrider',
  url_subid: '200030907400000000',
  url_maxlinks: '6',
  url_linkcolor: '009900',
  url_options: 'metarank',
  browserbase: 'chrome/safari',
  browserver: '29.0.1547.76',
  browsersupport: '1',
  appsig: 'S20131380730049z',
  subscribe: '',
  subscribe2: '',
  branduid: '05e85a9e2fa03038bbbe143733c55338|1379507230',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://kartograph.org/showcase/clustering/',
  page_url: '?',
  refer_domain: 'kartograph.org',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 var testLanding = "http://intext.advertise.com/misc/landing.html";
 ...
 function startup()
 {
  ...
  properties.userip = '147.215.200.20'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 147.215.200.20 not supported. uip=' + properties.userip);
   return (0);
  }
   ...
   if (metaCollection[i].name.toLowerCase() == 'keywords')
    {
     ...
     metakw=finalize_misc_text(metakw, 255);
   ...
   if (metaCollection[i].name.toLowerCase() == 'description')
    {
     ...
     metadesc=finalize_misc_text(metadesc, 255);
    }
  }

  h2text = getTagText('h2');
  h2text = cleanup_misc_text(h2text);
  h2text = finalize_misc_text(h2text, 255);

  title= cleanup_misc_text(title);
  title= finalize_misc_text(title, 255);
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url='http://kartograph.org/showcase/clustering/';
    properties.page_domain='kartograph.org';
   }
 ...
 writeLog(1,'url_afid='+properties.url_afid);
  ...
  setPublisherParmsByVar(afid, subid, maxlinks, linkcolor, options);
 
 }

 function setPublisherParmsByVar(afid, subid, maxlinks, linkcolor, options)
 {
...
function checkAdultPage()
{
 ...
 function supportedBrowser()
 {
  ...
  if (1 == 1 && ( (properties.browserbase == 'msie' && parseInt(properties.browserver) == 10)
                                                    ||
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('adtextpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg adtext_3, adtext_4, ... adtext_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.id = 'adtext' + "_" + properties.spancount;
     span.name='adtext' + "_" + properties.spancount; 
...
function build_clickthru(domain, afid, ecb, ptclickflag, url)
{
 ...
 function getBoxHeaderHTML()
 {
  ...
  // no drop shadows 
  html = '<div id="intxt_bdy" class="intxt_bg" style="position: relative; xtop: 100px; xleft: 100px; width:314px; height:185px; z-index: 10000113; padding:0 !important!; margin:0 !important;">'
          +'<div id="intxt_bdy_cntnt" class="intxt_bg" style="position: absolute; top: 0px; left: 0px; width: 314px; height: 185px; ">'
           +'<div class="intxt_bg" style="position:absolute; width:314px; height:33px; left:0; bottom:0; z-index:1; background-color:#cbcbce; border-bottom:3px solid #006699; border-left:1px solid #a7a9ab; border-right:1px solid #a7a9ab; -webkit-border-radius: 0px 0px 0px 0px; -moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px; " onclick="$adtext.footerClick();"> <!-- bottom frame -->'
 ...
 if (config.brand_title.length > 0)
  ...
  html = '<div id="intxt_bdy" class="intxt_bg" style="position: relative; xtop: 100px; xleft: 100px; width:314px; height:185px; z-index: 10000113;"> <div id="intxt_bdy_cntnt" class="intxt_bg" style="position: absolute; top: 0px; left: 0px; width: 314px; height: 185px; "> <div class="intxt_bg" style="position:absolute; width:314px; height:33px; left:0; bottom:0; z-index:1; background-color:#cbcbce; border-bottom:3px solid #006699; border-left:1px solid #a7a9ab; border-right:1px solid #a7a9ab; -webkit-border-radius: 0px 0px 0px 0px; -moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px; " onclick="$adtext.footerClick();"> <!-- bottom frame --> <div id="intxt_bdy_logo" class="intxt_bg" style="position:absolute; top:10px; left:5px; bottom:10px; cursor:default; font-size:14px; font-weight:bold;color:#ffffff;">'+config.brand_title+'&nbsp;<i><span style="font-family:arial; font-size:12px; color:#ffffff;">&nbsp;' + version + '</span></i></div> <div class="intxt_bg" id="intxt_hlp" style="position:absolute; padding:0; margin:0; width:26px; height:25px; right:35px; bottom:2px; display:block; background-position:0 0; cursor:pointer; color:#006699; font-family: Arial,sans-serif; font-size:10px; line-height:12px; font-weight:bolder; border-radius: 2px; xbackground: #ffffff;"><center><a href="' + helpurl + '" onclick="javascript:$adtext.closeAd(this); location=\'' + helpurl + '\';" style="color:#006699; font-family:arial,sans-serif; font-weight:bolder; font-size:10px; line-height:12px; text-decoration:none;"><img src="http://'+config.coreDomain+'/images/intext-help5.png" width=26 height=25 border=0></a></center> </div> <div class="intxt_bg" id="intxt_cls" style="position:absolute; width:26px; height:25px; right:5px; bottom:2px; background-position:-15px 0; cursor:pointer; color:#006699; font-family: Arial,sans-serif; font-size:10px; line-height:12px; font-weight:bolder; border-radius: 2px; xbackground: #ffffff;"> <center><span onclick="javascript:$adtext.closeAd(this);"><img src="http://'+config.coreDomain+'/images/intext-close5.png" width=26 height=25 border=0></span></center></div></div>';
  }
 ...
 {
  var html = '<div id="intxt_bdy" class="intxt_bg intxt_bdy_mn" style="position:absolute; top:0px; left:0; width:314px; height:152px; z-index:2; background-color:#ffffff !important; cursor: pointer; margin:0; padding:0; border-top:1px solid #9a9a9a; border-left:1px solid #9a9a9a; border-right:1px solid #9a9a9a; -webkit-border-radius: 0px 0px 0px 0px; -moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px;  text-decoration:none !important; text-align:left !important;">'

             +'<div xclass="intxt_bg" style="border-bottom:none; border:1px solid #ffffff; color:#006699; font-family: Arial,sans-serif; font-size:14pt; font-weight:bold; line-height:14pt; margin-left:15px; margin-top:10px; margin-bottom:10px; margin-right:5px; max-height:24pt; overflow:hidden; text-decoration:none !important;"> $TITLE </div>'

            +'<div class="intxt_bg" style="position:absolute; height:80px; width:312px; margin-top:5px"> <img class="intxt_bg" style="position:absolute; top:0; left:35px; width:48px; height:48px; background-color:#e8e8e8; margin-top:3px" src="http://'+config.coreDomain+'/images/intext-thdefault3.png" height="48" width="48">'

              +'<div class="intxt_bg" style="position:absolute; top:0; left:115px; width:168px; height:51px; overflow:hidden; color:#666666; font-family: Arial,sans-serif; font-size:10pt; font-weight:normal; line-height:17px;"> $DESC </div>'
              +'<div id="intxt_btn" class="intxt_bg" style="position:absolute; display:block; bottom:-13px; right:13px; width:102px; height:24px; font-family:Arial,sans-serif; font-size:10pt; font-weight:normal; cursor:pointer; text-align:center; line-height:24px; color:#ffffff; border-radius: 2px; background: #ac0b11; background: -webkit-gradient(linear, left top, left bottom, from(#da1f26), to(#ac0b11)); background: -moz-linear-gradient(top, #da1f26, #ac0b11); background: -webkit-linear-gradient(top, #da1f26, #ac0b11); background: -o-linear-gradient(top, #da1f26, #ac0b11); background: -ms-linear-gradient(top, #da1f26, #ac0b11); background: linear-gradient(top, #da1f26, #ac0b11); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=\'#da1f26\', endColorstr=\'#ac0b11\'); "> click here </div>'

           +'</div>'

           +'<div class="intxt_bg" style="position:absolute; bottom:12px; left:15px; width:280px; height:15px; color:#cc001c; font-family: Arial,sans-serif; line-height:10px; font-size:9pt; font-weight:normal; text-decoration:none; overflow:hidden;"> $VURL </div>'
...
function build_arrow_wrapper(boxHTML)
{
 ...
 if (properties.adpos_boxlrstyle == 'left' && properties.adpos_boxtbstyle == 'top')
  {
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:314px; height:185px; text-align:top !important;">';
  ...
  {
   html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:314px; height:185px; text-align:right !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'adtextspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickAdText,   false);
  addEvent(adpop_span, "click", doMouseClickAdText);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'adtextframe';
  gframe.name = 'adtextframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('adtextframe');
 ...
 function setupAdTextCSS()
 {
  writeLog(1, 'setupAdTextCSS()');
  ...
  // style.innerHTML = '.adtext { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.adtext { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';

  if (properties.browser == 'ie')
   {
    var rule='.adtext {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.adbox  { padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2e9; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.adtext {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.adtext {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.adbox  { padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2e9; text-decoration:none !important;}';
...
/* $adtext.processPage(); */
try { $adtext.processPage(); } catch(e)
{
  var rnum = Math.floor(Math.random() * (1000 * 1000));
  if (1==0)
   {
    try
     {
      var img= new Image();
      img.src='http://intext2.nav-links.com/util/intexteval.pl?op=msg&action=rte&r='+rnum+'&msg='+encodeURIComponent(e);
     }
    catch(e) {}
   }
}
